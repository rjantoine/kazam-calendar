...
const GenerateLink = React.forwardRef(({value, onChange, document}) => <>
    ...
    { value && <TextInput suffix={<Paste value={`webcal://kazam-calendar.vercel.app/api/cal/${document.slug.current}/${value}`} />} value={`webcal://kazam-calendar.vercel.app/api/cal/${document.slug.current}/${value}`} style={{paddingTop: 12, paddingBottom: 12}} /> }
</>)
